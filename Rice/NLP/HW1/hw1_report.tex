...
\section*{Problems 3 and 4: Coding}

The solutions for \textbf{Problem 3} (Text Classification with Bag-of-Words) and \textbf{Problem 4} (TF-IDF) are provided in the attached Jupyter notebook:
...
\begin{itemize}[nosep]
    \item Binary and Count Bag-of-Words implementations
    \item TF-IDF vectorization
    \item Two-layer neural network classifier
    \item Training loop with PyTorch autograd
    \item Performance comparison and analysis
\end{itemize}
